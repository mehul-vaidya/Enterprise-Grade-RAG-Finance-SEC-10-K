...
# step 4 – LLM generation using LOCAL model (Ollama)
# replaces OpenAI with local LLaMA / Mistral
#install ollama
#1.ollama serve
...
# =========================
# GENERATE ANSWER (LOCAL)
# =========================
def generate_answer(query, reranked_chunks):
    prompt, citations = build_prompt(query, reranked_chunks)
